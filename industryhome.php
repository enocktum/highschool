		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="industryhome">Finance Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Finance Home</h2>
			<p>
                Welcome finance officer, this page allows you to view the school fees and related voteheads of all the terms.
			</p>
            <p>
            <?php
			include"connection.php";
			error_reporting(E_ERROR);
			//term one oncampus info
			echo"<fieldset>";
			...
			<td style="color:brown;"><b><u>KSHS. '.$total.'</b></u></td>
			</tr>
			</table>
			';
			}
			...
			{
			echo"there are no voteheads for oncampus for this term, you can add voteheads via <u>MANAGE FEES</u> option";	
			}
			echo"</fieldset>";
			//end of term one oncampus info
			
			//term one offcampus info
			echo"<fieldset>";
			...
			{
			echo"there are no voteheads for offcampus for this term, you can add voteheads via <u>MANAGE FEES</u> option";	
			}
			echo"</fieldset>";
			//end of term one offcampus info
			
			
			//term two oncampus info
			echo"<br/><br/><fieldset>";
			...
			echo"</fieldset>";
			//end of term two oncampus info
			
			//term two offcampus info
			echo"<fieldset>";
			...
			echo"</fieldset>";
			//end of term two offcampus info
			
			//term three oncampus info
			echo"<br/><br/><fieldset>";
			...
			echo"</fieldset>";
			//end of term three oncampus info
			
			//term three offcampus info
			echo"<fieldset>";
			...
			echo"</fieldset>";
			//end of term three offcampus info
			?>
			<br/><br/>
            </p>
