		...
		?>
			...
			if(isset($studentid) && isset($amount))
			{
				 ...
				 if($nyeri)
				 {
					...
					if($feespayable<0)
					{
					$studentstatus="Fully Paid, excess carried forward(fees posted by bursar directly)";
					}
					elseif($feespayable>0)
					{
					$studentstatus="Partially Paid(fees posted by bursar directly)";
					}
					elseif($feespayable==0)
					{
					$studentstatus="Fully Paid(fees posted by bursar directly)";
					}
					else
					{
					...
					//end of checking student status
					 ...
					 {
					     echo"<font color='green'>fee for student <u><strong> $studentid </strong></u> has been successfully updated and the financial statement up to date</font><font color='red'> but financial statement not updated</font><br/><a href='industryfinancialstatement'>go back</a>";
					 }
				 }
				 else
				 {
				     echo"fees update not successful<br/><a href='industryfinancialstatement'>Try Again</a>";
				 }
			}
			else
			{
			     echo"page cannot be accessed directly<br/><a href='industryfinancialstatement'>Try Again</a>";
			}
			?>
			</p>
		</center>
