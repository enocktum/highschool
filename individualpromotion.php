		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">individual promotion of student</h2>
			<p>
			<center>
			<?php
			error_reporting(E_ERROR);
			...
			if($studentid && $nextclass)
			{
				 ...
				 if($no==1)
				 {
					 ...
					 {
					     echo"<fieldset>";
						 echo"<legend><font color='red' size='6'><b>CAUTION!!<b></font></legend>";
						 echo'
						 You are about to transfer a student from a higher class ('.$currentclass.') to a lower class ('.$nextclass.')<br/><br/>
						 <form action="individualyesorno" method="post">
						 are you sure:<br/>
					 ...
					 {
					     echo"<fieldset>";
						 echo"<legend><font color='GREEN' size='5'><b>INFORMATION!!<b></font></legend>";
						 echo'
						 You are about to transfer a student from a lower class ('.$currentclass.') to a higher class ('.$nextclass.')<br/><br/>
						 <form action="individualyesorno" method="post">
						 are you sure:<br/>
						 <input type="radio" name="sure" value="yes"> YES<br/>
						 <input type="radio" name="sure" value="no"> NO <br/><br/>
					 ...
					 {
					     echo"<fieldset>";
						 echo"<legend><font color='green' size='6'><b>INFORMATION!!<b></font></legend>";
					     echo"There is no need for promotion since the student is currently in the class you are trying to promote him/her to<br/><a href='exampromotestudent'>Try Again if you made an error</a>";
						 echo"</fieldset>";
					 }
				 }
				 else
				 {
				     echo"student is either discontinued or does not exist in the database, consult the student registration officer<br/>
					 <a href='exampromotestudent'>Try Again</a>
					 ";
				 }
			}
			else
			{
			     echo"necessary variables not passed in<br/> <a href='exampromotestudent'>Try Again</a>";
			}
			?>
			</center>
			</p>
