		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="index">Portal</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					<!-- BEGIN CAROUSEL ITEM -->
					<div class="the-box no-border" style="background-image:url('images/background.jpg');background-size:cover;background-repeat:no-repeat;color:#FFFFFF;height:50em;">
					<center>
					<p style="font-size:3em;font-family:monotype corsiva;text-align:left;">
					Welcome to Enosoft Highschool Management Software
					</p>
					<br/><br/>
					</center>
