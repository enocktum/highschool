		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li><a href="boardadmission">Examination</a></li>
							<li class="active selected"><a href="industry">Industry</a></li>
						</ul>
					</li>
					<li>
						<a href="">
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">industry login confirmation</h2>
			<p>
			<?php
			$username=$_POST['username'];
			$password=$_POST['password'];
			$rejex="/[=<>*$&#'\"]/";
			$use=preg_match($rejex,$username);
			...
			{
				include("connection.php");
				$query=mysqli_query($con,"select * from industrydetails where username='$username' and password='$password'");
				$no=mysqli_num_rows($query);
				if($no != 0)
				{
					session_start();
					$_SESSION['industrylogin']=$username;
					header("location:industryhome");
				}
				else
				{
					echo"<font color='#FF0000'>Incorrect Login Credentials</font><br/><br/><a href='industry'>Try Again</a>";
				}
			}
			else
			{
				echo"<a href='industry'>fill all the fields</a>";
			}
			}
			else
			{
				echo"You have included unallowed characters to our server<br/><a href='industry'>Try Again</a> ";
		    }
			?>
			</p>
...
<html>
<head>
<title>System Time not Set</title>
<style type="text/css">
body
{
...
<center>
<div class="header">
<marquee direction="left" scrollamount="20"><strong>DATE AND TIME NOT SET</strong></marquee>
</div>
</center>
<center>
<div class="content">
     <div class="contentinner">
	 <h1>PLEASE SET THE TIME FOR ACCURACY PURPOSE</h1>
	 <a href="portal">CLICK HERE  AFTER SETTING THE DATE OF THE SYSTEM</a>
	 </div>
</div>
</center>
</body>
