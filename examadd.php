		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are adding an exam</h2>
			<p>
            <center>
            <?php
			error_reporting(E_ERROR);
			...
			if($name && $class)
			{
				$check=mysqli_query($con,"select * from exams where name='$name' && class='$class'");
				$number=mysqli_num_rows($check);
				if($number > 0)
				{
					echo"exam already exists<br/><a href='exambasicsettings'>Go Back</a>";
				}
				else
				{
					$insert=mysqli_query($con,"insert into exams (name,class) values ('$name','$class')");
					if($insert)
					{
					...
					{
						echo"exam not added successfully<br/><a href='exambasicsettings'>Try Again</a>";
					}
				}
			}
			else
			{
                ...
                type exam name:<input type="text" name="name" placeholder="exam name goes here" /><br/><br/>
