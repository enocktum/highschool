		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Finance Voteheads</h2>
			...
			//end term info
			        error_reporting(E_ERROR);
			        $voteheadname=$_POST['voteheadname'];
					$voteheadamount=$_POST['voteheadamount'];
					...
					if(isset($voteheadname) && isset($voteheadamount))
					{
						...
						if($insert)
						{
							...
							{
								echo"<font color='#FF0000'>fees not updated but </font>";
							}
							echo"<font color='#009933'>votehead has been inserted successfully</font><br/><a href='industrymanagefees'>Go Back</a>";
						}
						else
						{
							//echo"<font color='#FF0000'>votehead insertion unsuccessful</font><br/><a href='industrymanagefees'>Try Again</a>";
						}
						}
					}
					else
					{
						//it waits for the variable hopefully
						echo"fill all the fields<br/><a href='industrymanagefees'>Try Again</a>";
						//end of waiting for variable hopefully
					}
					}
					else
					{
