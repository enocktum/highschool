		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="admissionhome">Admission Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>WELCOME</h3>
						<p>This module uses enosoft technology to enable you to register and edit both teachers and students to the system</p>
						<br/><br/>
						<img src="assets/img/enosoft.jpg" style="width:70%;"/>
						<br/><br/>
						</center>
