...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="teachers">Teachers</a></li>
			...
			{
				include("connection.php");
				$query=mysqli_query($con,"select * from teacherdetails where username='$username' and password='$password'");
				$no=mysqli_num_rows($query);
				if($no != 0)
				{
					session_start();
					$_SESSION['teacherlogin']=$username;
					header("location:teachershome");
				}
				else
				{
					echo"<font color='#FF0000'>Incorrect Login Credentials</font><br/><br/><a href='teachers'>Try Again</a>";
				}
			}
			else
			{
				echo"<a href='teachers'>fill all the fields</a>";
			}
			}
			else
			{
				echo"You have included unallowed characters to our server<br/><a href='teachers'>Try Again</a> ";
		    }
			?>
