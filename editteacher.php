	...
	<body class="tooltips">
		...
		?>
			...
			while($data=mysql_fetch_array($check))
			{
				...
				echo"<form action='editteacherpage' method='post'>";
				echo"<input type='hidden' value='".$data['teacherdetailsid']."' name='editteacher'/>";
				echo"<td><input style='background-color:#090;color:white;width:100%;' type='submit' value='edit teacher'/></td>";
				echo"</form>";
				echo"</tr>";
			}
			echo"</table>";
