		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are adding a grade</h2>
			<p>
            <center>
            <?php
			error_reporting(E_ERROR);
			...
			if($grade && $range && $subject && $comments)
			{
				...
				else
				{
					...
					{
						echo"grade not added to table<br/><a href='exambasicsettings'>Try Again</a>";
					}
			...
			{
				echo'
				<fieldset style="width:40em;text-align:left;">
				<form action="" method="post">
                type grade(e.g A ):<input style="text-transform:uppercase;" type="text" name="grade" placeholder="" required="required"/><br/><br/>
				type range:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="range" placeholder="(e.g 70-50 )" required="required"/><br/><br/>
				type comments:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="comments" placeholder="(e.g good)" required="required"/><br/><br/>
				';
				?>
				chose subject:&nbsp;&nbsp;&nbsp;&nbsp;
                <select name="subject">
