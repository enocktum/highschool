...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
			...
			if($name && $category)
			{
				$check=mysql_query("select * from subject where name='$name'");
				...
				{
					$insert=mysql_query("insert into subject (name,category) values ('$name','$category')");
					if($insert)
					{
			...
			else
			{
				...
				';
				$cate=mysql_query("select * from subjectcategory order by name");
