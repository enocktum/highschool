		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are editing a stream</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id)
			{
				$yeah=mysqli_query($con,"SELECT * FROM streams where streamsid='$id'");
				$str=mysqli_fetch_array($yeah);
				$name=$str['name'];
				echo'
				<form action="examstreameditconfirm" method="post">
