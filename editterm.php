		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">change term result</h2>
			<p>
			<center>
            <?php
			include"connection.php";
			...
			if($term)
			{
			     $update=mysqli_query($con,"update currentterm set term='$term'");
				 if($update)
				 {
				     echo"The current term has been updated successfully. The current term is <b><u>$term</u></b><br/><a href='exambasicsettings'>Go Back</a>";
				 }
				 else
				 {
				     echo"term not currently updated";
				 }
			}
			else
			{
			     echo"necessary variables not sent<br/><a href='exambasicsettings'>Try Again</a>";
			}
			?>
			</center>
			</p>
