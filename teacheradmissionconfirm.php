	...
	<body class="tooltips">
		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li><a href="studentadmission">Student Admission</a></li>
							<li class="active selected"><a href="teacheradmission">Teacher Admission</a></li>
			...
			if($usernam && $passwor)
			{
				...
				{
					session_start();
					$_SESSION['teacherregistrationlogin']=$usernam;
					header("location:teacheradminhome");
				}
				else
				{
					echo"<font color='#FF0000'>Incorrect Login Credentials</font><br/><br/><a href='teacheradmission'>Try Again</a>";
				}
			}
			else
			{
			...
			{
				echo"You have included unallowed characters to our server<br/><a href='teacheradmission'>Try Again</a> ";
		    }
			?>
