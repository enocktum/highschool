		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are editing a grade</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id)
			{
				$yeah=mysqli_query($con,"SELECT * FROM gradingsystem where gradingsystemid='$id'");
				$str=mysqli_fetch_array($yeah);
				$grade=$str['grade'];
				$rangee=$str['rangee'];
				$comments=$str['comments'];
				$subject=$str['subject'];
				echo'
				<form action="examgradeeditconfirm" method="post">
				<input type="hidden" value="'.$id.'" name="id"/>
				edit grade:<input type="text" value="'.$grade.'" name="grade"/><br/><br/>
				edit range:<input type="text" value="'.$rangee.'" name="rangee"/><br/><br/>
				edit comment:<input type="text" value="'.$comments.'" name="comments"/><br/><br/>
				edit subject:<input type="text" value="'.$subject.'" name="subject"/><br/><br/>
