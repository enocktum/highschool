		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="exampromotestudent">Pro(De)mote Students</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">promote student(s)</h2>
			<p>
			<center>
			<?php
			echo'
			<form action="" method="post">
			select choice of individual or class qualified to promote: 
			<select name="choice">
			...
			if($choice)
			{
				 ...
				 {
				     echo"<fieldset>";
				     echo"<legend>INDIVIDUAL PROMOTION OF STUDENT</legend>";
					 echo'
					 <form action="individualpromotion" method="post">
					 <span id="txtHint"></span><br/>
					 enter student id:<input type="text" name="studentid" placeholder="student id goes here" id="txt1" onKeyUp="showHint(this.value)"/><br/><br/>
					 select class to be promoted to:
					 <select name="class">
					 <option>1</option>
					 <option>2</option>
					 <option>3</option>
					 ...
					 <input type="submit" value="Promote Student"/>
					 </form>
					 ';
				     echo"</fieldset>";
				 }
				 else
				 {
					 ...
					 while($em=mysql_fetch_array($allof))
					 {
					     ...
					     $currentclass=$em['currentclass'];
					     $nextclass=$currentclass+1;
					     echo'<tr>';
						 echo'<td>'.$em['firstname'].' '.$em['lastname'].' '.$em['middlename'].'</td>';
						 echo'<td>'.$em['admissionnumber'].'</td>';
						 echo'<td>'.$em['currentclass'].'</td>';
						 echo'<td>'.$nextclass.'</td>';
						 echo'<td><input type="checkbox" name="'.$counter.'admissionnumber" value="'.$em['admissionnumber'].'" checked="checked"</td>';
						 echo'</tr>';
						 $counter=$counter+1;
					 }
					 foreach($yote as $one)
					 ...
					 <br/><br/>
					 <input type="hidden" value="'.$currentclass.'" name="currentclass"/>
					 <input type="hidden" value="'.$string.'" name="collection"/>
					 <input type="submit" value="PROMOTE SELECTED STUDENTS"/>
					 </form>
					 ';
				     echo"</fieldset>";
				 }
			...
			{
			     echo"<fieldset>";
				 echo"<legend>Default Choice</legend>";
			     echo"No choice selected in the menu above, please select a choice and submit choice";
				 echo"</fieldset>";
			}
			?>
			</center>
