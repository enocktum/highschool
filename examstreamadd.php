		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are adding a stream</h2>
			<p>
            <center>
            <?php
			error_reporting(E_ERROR);
			...
			if($name)
			{
				...
				else
				{
					...
					{
						echo"stream not added successfully<br/><a href='exambasicsettings'>Try Again</a>";
					}
				}
			}
			else
			{
                ...
                type stream name:<input type="text" name="name" placeholder="stream name goes here" /><br/><br/>
