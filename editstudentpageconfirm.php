		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<?php
            $editidentifier=$_POST['editidentifier'];
			if($editidentifier)
			{
           ...
           {
           echo"Student editting not successful";	
           }
           }
		   else
		   {
				echo"You have included unallowed characters in  password change. Use letters or numbers only<br/><a href='editstudent'>Try Again</a> ";
		   }
			}
			else
			{
				echo"neccessary variables not sent in<br/><a href='editstudent'>Try Again</a>";
			}
?>
