		...
		?>
				...
				<ul class="sidebar-menu">
					...
					<li>
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="aboutus">About Us</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>ABOUT ENOSOFT COMPANY</h3>
					<p>Enosoft Company is a products and service company that deals with software of all kinds as shown below</p>
					<a href=""><img src="images/app_mobile.png" alt="" style="width:60%;"/></a>
					<br/><br/>
					<a href=""><img src="images/app_desktop.png" alt="" style="width:60%;"/></a>
					<br/><br/>
					<a href=""><img src="images/app_website.png" alt="" style="width:60%;"/></a>
					<br/><br/>
					<a href=""><img src="images/app_embedded.png" alt="" style="width:60%;"/></a>
					<br/><br/>
					</center>
