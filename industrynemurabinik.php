			...
			if($to && $amount && $votehead)
			{
				...
				if($updatetotal)
				{
					...
					if($insertpayment)
					{
						...
						echo"<form action='industryprintpayment' method='post'>";
						echo"<input type='hidden' name='name' value='$to'/>";
						echo"<input type='hidden' name='votehead' value='$votehead'/>";
						echo"<input type='hidden' name='amount' value='$amount'/>";
						echo"<input type='hidden' name='paymentno' value='$paymentno'/>";
						echo"<input type='submit' value='print payment' style='background-color:green;color:white;'/>";
						echo"</form>";
					}
					else
					{
						echo" but recording in the payments book failed.";
					}
				}
				else
				{
					echo"Withdrawal not successful, try again<br/><a href='industrymanagefees'>Try Again</a>";
				}
			}
			else
			{
				echo"<a href='industrymanagefees'>Fill all the Fields</a>";
			}
			?>
            </p>
