...
{
	header("location:studentadminhome");
}
?>
<!DOCTYPE html>
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
			...
			{
				include("connection.php");
				$query=mysqli_query($con,"select * from studentadmissionlogin where username='$username' && password='$password'");
				...
				if($query)
				{
					...
					{
					    session_start();
						$_SESSION['studentregistrationlogin']=$username;
						header("location:studentadminhome");
					}
					else
					{
						echo"<font color='#FF0000'>Incorrect Login Credentials</font><br/><br/><a href='studentadmission'>Try Again</a>";
					}
				}
				else
				{
					echo"No such table in our database";
				}
			}
			else
			{
				echo"<a href='studentadmission'>fill all the fields</a>";
			}
			}
			else
			{
				echo"You have included unallowed characters to our server<br/><a href='studentadmission'>Try Again</a> ";
		    }
			?>
