		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Finance Delete Votehead Result</h2>
			...
			{
			header("location:industrymanagefees");
			}
			?>
            
            <form action="industryeditvoteheadconfirm" method="post">
            Edit votehead name:&nbsp;&nbsp;&nbsp;<input type="text" value="<?php echo $name; ?>" name="name" required="required"/><br/><br/>
            Edit votehead amount:<input type="text" value="" name="amount" placeholder="initial value is <?php echo $amount; ?>" required="required"/><br/><br/>
            <input type="hidden" value="<?php echo $id; ?>" name="id" required="required"/>
            <input type="hidden" value="<?php echo $term; ?>" name="term" required="required"/>
            <input type="hidden" value="<?php echo $boardingstatus; ?>" name="boardingstatus"/>
            <input type="submit" value="Update Votehead"/>
            </form>
            </center>
            </p>
