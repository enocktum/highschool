	...
	<body class="tooltips">
		...
		?>
			...
			if($delete)
			{
				...
				//end of fees update
				echo"<font color='#009933'>votehead deleted successfully</font><br/><a href='industrymanagefees'>Go Back</a>";
			}
			else
			{
				echo"<font color='#FF0000'>votehead not deleted successfully</font><br/><a href='industrymanagefees'>Try Again</a>";	
			}
			}
			else
			{
