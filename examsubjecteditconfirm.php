		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">subject edit confirm results</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id && $name)
			{
				$update=mysqli_query($con,"update subject set name='$name',category='$category' where subjectid='$id'");
				if($update)
				{
				...
				{
					echo"subject not updated<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
