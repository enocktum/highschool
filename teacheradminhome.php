		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="teacheradminhome">Teacher Admin Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>Teacher Admin Home</h3>
						<p>This module uses enosoft technology to enable you to add,update and delete a teacher from the login list in the system.</p>
						<br/><br/>
