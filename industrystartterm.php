		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="industrystartterm">Start Term(Update Fees)</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Finance Start Term</h2>
			<p>
            <center>
			   ...
			   ?>
			   <input style="width:4em;height:4em;" id="chekit" type="checkbox" name="confirm" onchange="chekit()"/><p style="text-align:left;font-size:2em;font-family:monotype corsiva;"> By checking the box above, you are confirming that term <b style="text-transform:uppercase;color:red;"><?php echo $tam; ?></b> has ended and you are ready to start term <b style="color:red;text-transform:uppercase;"><?php echo $nextterm; ?></b> hence updating students current charges according to the vote heads of term <?php echo $nextterm; ?>.</p><br />
               <input id="confirmbutton" type="submit" value="Start Term" style="width:20em;height:5em;font-size:2em;" />
			   </form>
            </center>
			</p>
