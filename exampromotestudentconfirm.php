		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">promote students results</h2>
			<p>
			<center>
			<?php
			error_reporting(E_ERROR);
			...
			if($collection && $currentclass)
			{
				 $one=explode(",",$collection);
				 foreach($one as $onebyone)
				 {
				     //getting form inputs
					 $admissionnumber=$_POST[$onebyone];
					 if($admissionnumber)
					 {
						 ...
						 {
						     echo"<font color='red'>student with admission number ".$admissionnumber." who is in form ".$currentclass." has not been successfully promoted to form ".$nextclass."</font><br/>";
						 }
					 }
					 //end of getting form inputs
				 }
			}
			else
			{
			     echo"There are no students in the class to be promoted or required variables not passed in<br/><a href='exampromotestudent'>Try Again</a>";
			}
			?>
			</center>
			</p>
