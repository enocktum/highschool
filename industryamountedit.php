	...
	<body class="tooltips">
		...
		<center>
			...
			if($studentid)
			{
				 ...
				 enter current fee balance for $studentid: <input size='30' type='text' name='amount' placeholder='previous amount is $previousamount' required='required'/>
				 <input type='submit' style='background-color:blue;color:white;' value='update fee for ".$studentid."'/>
				 </form>
				 ";
			}
			else
