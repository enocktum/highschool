		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="teachershome">Teacher Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>Teacher Home</h3>
						<p>This module uses enosoft technology to enable you as a teacher to add grades and modify grades in the system.</p>
						<br/><br/>
