		...
		?>
			...
			if($studentid && $boardingstatus)
			{
			    if($boardingstatus=="oncampus")
				{
					...
					{
					    echo"boarding status not changed in student status<br/><a href='viewstudent'>Try Again</a>";
					}
				}
			...
			{
			    echo"student id or status not passed<br/><a href='viewstudent'>Try Again</a>";
			}
			?>
            </center>
