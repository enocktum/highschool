		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="examsetup">Exams Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>Examination Admin Home</h3>
					<p>This module uses enosoft technology to enable you to manipulate examination records to the system.</p>
					<br/><br/>
