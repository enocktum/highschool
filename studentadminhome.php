		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							<li class="active selected"><a href="studentadminhome">Student Admin Home</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<center>
					<h3>Student Admin Home</h3>
						<p>This module uses enosoft technology to enable you to add,edit,update, select course, retire and graduate students from the system.</p>
						<br/><br/>
