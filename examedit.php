		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are editing an exam</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id)
			{
				$yeah=mysqli_query($con,"SELECT * FROM exams where examsid='$id'");
				$str=mysqli_fetch_array($yeah);
				$name=$str['name'];
				$class=$str['class'];
				echo'
				<form action="exameditconfirm" method="post">
				<input type="hidden" value="'.$id.'" name="id"/>
				edit name: <input type="text" value="'.$name.'" name="name"/><br/><br/>
				edit class:<input type="text" value="'.$class.'" name="class"/><br/><br/>
