			...
			if($string)
			{
				 ...
				 foreach($yote as $agenge)
				 {
					 ...
					 if($username)
					 {
						 ...
						 {
						     echo"An error occured while retiring after graduation student $username<br/><a href='viewstudent'>Try Again</a><br/>";
						 }
						 
					 }
					 else
					 {
						 echo"please select the students you want to retire after graduation before submitting the information<br/><a href='viewstudent'>Try Again</a>";
					 }
				 }
			}
			else
			{
			echo"necessary variables not sent in<br/><a href='viewstudent'>Try Again</a>";
			}
			?>
