...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
			...
			<form action="teacherbasicinfo" method="post">
			number of students in that exam<br/><select name="noofstudents" style="width:60%;">
			<?php
			$counter=1;
			...
			enter your raw marks<br/><input style="width:60%;" type="text" placeholder="raw marks enter here" name="rawmarks" required="required"/><br/><br/>
