		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">delete stream progress</h2>
			<p>
            <center>
            <?php
			error_reporting(E_ERROR);
			...
			if($id)
			{
				$delete=mysqli_query($con,"delete from streams where streamsid='$id'");
				if($delete)
				{
				...
				{
					echo"stream not deleted<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
