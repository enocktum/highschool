...
{
echo"teacher editting not successful";	
}

           }
		   else
		   {
				echo"You have included unallowed characters in  password change. Use letters or numbers only<br/><a href='editteacher'>Try Again</a> ";
	
	   }
		   }
		   else
		   {
			   echo"fill the required fields in the edit confirm page<br/><a href='editteacher'>Try Again</a>";
		   }
		   }
		   else
		   {
