		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">you are editing a subject</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id)
			{
				$yeah=mysqli_query($con,"SELECT * FROM subject where subjectid='$id'");
				$str=mysqli_fetch_array($yeah);
				$name=$str['name'];
				$category=$str['category'];
				echo'
				<form action="examsubjecteditconfirm" method="post">
				<input type="hidden" value="'.$id.'" name="id"/>
				<input style="width:25em;" type="text" value="'.$name.'" name="name"/><br/><br/>
				<select style="width:25em;" name="category">
				';
