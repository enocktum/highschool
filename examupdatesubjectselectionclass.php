...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
			...
			if($class)
			{
				$update=mysqli_query($con,"UPDATE subjectchoiceclass SET class='$class'");
				if($update)
				{
				...
				{
					echo"subject-selection class not updated successfully<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
				echo"required variable not passed<br/><a href='exambasicsettings'>Try Again</a>";
			}
			?>
            </center>
			</p>
