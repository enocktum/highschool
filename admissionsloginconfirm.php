...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="admissions">Registration</a></li>
			...
			//$string="adminpass";
			//$yeah=crypt($string,CRYPT_MD5);
			//echo $yeah;
			$usernam=$_POST['username'];
			$password=$_POST['password'];
			$rejex="/[=<>*$&#'\"]/";
			$use=preg_match($rejex,$usernam);
			...
			{
				include("connection.php");
				$query=mysqli_query($con,"select * from admissionlogin where username='$usernam' and password='$password'");
				$no=mysqli_num_rows($query);
				if($no != 0)
				{
					session_start();
					$_SESSION['admissionlogin']=$usernam;
			...
			{
				echo"<a href='admissions'>fill all the fields</a>";
			}
			}
			else
			{
				echo"You have included unallowed characters to our server<br/><a href='admissions'>Try Again</a> ";
		    }
			?>
