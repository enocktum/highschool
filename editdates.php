		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">editing date results</h2>
			<p>
			<center>
            <?php
			error_reporting(E_ERROR);
			...
			{
			     $update=mysqli_query($con,"update currentterm set openingdate='$openingdate',closingdate='$closingdate'");
				 if($update)
				 {
				 ...
				 {
				     echo"dates not updated successfully<br/><a href='editdates'>Try Again</a>";
				 }
			}
			else
			{
			     echo"sorry, incorrect variables not passed in<br/><a href='editdates'>Try Again</a>";
			}
			?>
			</center>
			</p>
