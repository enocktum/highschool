...
<html lang="en">
	...
	<body class="tooltips">
		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li><a href="teachersassigngrade">Assign Grades</a></li>
							<li class="active selected"><a href="teachersperformancereport">Perfomance Report</a></li>
            ...
            <option>edit student result</option>
            </select>
			...
			if($choice)
			{
				if($choice=="subject results")
				{
			?>
					<form action="teachersubjectresults" method="post">
					<fieldset style="width:40em;">
					<legend><strong>SUBJECT BASIC DETAILS</strong></legend>
					...
					select year:<br/> 
                    <select style='width:25em;text-align:center;' name="year">
                    <?php
					$year=date("Y");
					?>
                    ...
                    select term:<br/>
                    <select style='width:25em;text-align:center;' name="term">
                    <option>one</option>
                    <option>two</option>
                    <option>three</option>
                    </select><br/><br/>
                    select class:<br/>
                    <select style='width:25em;text-align:center;' name="class">
                    <option>1</option>
                    <option>2</option>
                    <option>3</option>
                    <option>4</option>
            ...
            <?php
				...
				elseif($choice=="edit student result")
				{
			?>
					<form action="teachereditresults" method="post">
					<fieldset style="width:40em;">
					<legend><strong>STUDENT GRADE EDIT DETAILS</strong></legend>
                    <h3>select the options below and submit to get result</h3>
					enter student username:<br/>
					<input type="text" name="username" placeholder="student admission number goes here" style='width:25em;text-align:center;' required="required"/><br/><br/>
					student marks to be updated(in percentage i.e out of 100):<br/>
                    ...
                    <input type="submit" value="Update Student Grade"/>
					</fieldset>
					</form>
					<br/><br/><br/>
			...
			{
			echo"No Action has been performed, choose an action above and submit the action using Perform Action";
			}
			?>
			</fieldset>
            </center>
