		...
		?>
				...
				<ul class="sidebar-menu">
					<li class="active selected">
						...
						<ul class="submenu visible">
							...
							<li class="active selected"><a href="boardadmission">Examination</a></li>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Board Registration Login</h2>
			<center>
			<p>
            <?php
			error_reporting(E_ERROR);
			...
			{
				include("connection.php");
				$query=mysqli_query($con,"select * from boardadmissionlogin where username='$username' and password='$password'");
				$no=mysqli_num_rows($query);
				if($no != 0)
				{
					session_start();
					$_SESSION['examsetup']=$username;
					header("location:examsetup");
				}
				else
				{
					echo"Wrong username or password<br/><a href='boardadmission'>Try Again</a>";
				}
			}
			else
			{
				echo"<a href='boardadmission'>fill all the fields</a>";
			}
			}
			else
			{
				echo"You have included unallowed characters to our server<br/><a href='boardadmission'>Try Again</a> ";
		    }
			?>
			</p>
			</center>
