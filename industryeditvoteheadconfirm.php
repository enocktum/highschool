		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">Finance Edit Votehead Result</h2>
			...
			if($name && $id)
			{
				$update=mysqli_query($con,"update voteheads set name='$name',amount='$amount' where voteheadid='$id' && termit='$term' && boardingstatus='$boardingstatus'");
				if($update)
				{
				...
				//end of fees update
					echo"<font color='#009933'>Votehead updated successfully </font><br/><a href='industrymanagefees'>Go Back</a>";
				}
				else
				{
					echo"<font color='#FF0000'>Votehead not updated successfully</font><br/><a href='industrymanagefees'>Try Again</a>";
				}
			}
			else
			{
				echo"no view selected<br/><a href='industrymanagefees'>Try Again</a>";
			}
			}
			else
			{
