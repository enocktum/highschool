		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">exam edit confirm results</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id && $name && $class)
			{
				$update=mysqli_query($con,"update exams set name='$name',class='$class' where examsid='$id'");
				if($update)
				{
				...
				{
					echo"exam not updated<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
