		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">delete grade progress</h2>
			<p>
            <center>
            <?php
			error_reporting(E_ERROR);
			...
			if($id)
			{
				$delete=mysqli_query($con,"delete from gradingsystem where gradingsystemid='$id'");
				if($delete)
				{
				...
				{
					echo"grade not deleted<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
				echo"required variables for deleting not passed<br/><a href='exambasicsettings'>Try Again</a>";
			}
			?>
            </center>
			</p>
