		...
		?>
			...
			<br/><br/>
				<div class="container-fluid">
					...
					<h2 style="font-size:1.7em;color:green;text-transform:uppercase;text-align:center;">stream edit confirm results</h2>
			<p>
            <center>
            <?php
			include("connection.php");
			...
			if($id && $name)
			{
				$update=mysqli_query($con,"update streams set name='$name' where streamsid='$id'");
				if($update)
				{
				...
				{
					echo"stream not updated<br/><a href='exambasicsettings'>Try Again</a>";
				}
			}
			else
			{
